<h2><a href="https://leetcode.com/problems/traffic-light-controlled-intersection">1410. Traffic Light Controlled Intersection</a></h2><h3>Easy</h3><hr><p>There is an intersection of two roads. First road is road A where cars travel&nbsp;from North to South in direction 1 and from South to North in direction 2. Second road is road B where cars travel from West to East in direction 3 and from East to West in direction 4.</p>
